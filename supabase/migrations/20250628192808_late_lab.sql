...
DROP POLICY IF EXISTS "Allow all operations for authenticated users" ON work_group_members;
CREATE POLICY "Allow all operations for authenticated users"
...
-- VIP2 (Nivel 2) - Incluye todos los de VIP1 + nuevos
...
-- VIP3 (Nivel 3) - Incluye todos los anteriores + nuevos
...
-- VIP4 (Nivel 4) - Incluye todos los anteriores + nuevos
...
(
    ...
    '{"statistics_enabled": false, "export_enabled": false, "history_limit": 30}'::jsonb,
    ARRAY['normal']
)
